...
public class ApostolicSongs extends Application {
   ...
   public static void saveToFile(Context context, String Filename, String FileVlaue) {
  ...
  public static String ReadFromFile(Context context, String Filename, String DefValue) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(Filename,
                Context.MODE_PRIVATE);
   ...
   public static void saveTheme(Context context, Integer FileValue) {
