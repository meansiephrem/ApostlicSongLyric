...
public class SelectAll extends ActionBarActivity implements  AlbumListner {
    ...
    public void goToAlbum(char select ,String name)
    {
        if(select=='C')
        {
           ...
           Intent intt = new Intent(SelectAll.this,Lyric.class).putExtra(Intent.EXTRA_TEXT,name);
           startActivity(intt);
        ...
        else if(select=='D')
        {
            ...
            Intent intent=new Intent(SelectAll.this,DisplayALbums.class).putExtra(Intent.EXTRA_TEXT,0+""+name);
